...
const Cart = () => {
    const {products, currency, cartItems, removeFromCart, updateCartItem, setCartItems, getCartCount, getCartAmount, navigate, axios, user} = useAppContext()
        ...
        <div className="flex flex-col md:flex-row mt-16">
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <button 
                    ...
                    {paymentOption === "COD" ? "Place Order" : "Check Out"}
                </button>
            </div>
        </div>
    ) : null
